# VPP CFLA projekts "Mākslīgā intelekta metožu piemērotības analīze Eiropas Savienības fondu projektu jomā"

Projekta mērķis ir novērtēt ģeneratīvā mākslīgā intelekta (ĢMI) piemērotību un efektivitāti Eiropas Savienības (ES) fondu projektu iepirkumu dokumentācijas analīzē.

Projekts satur prototipa (demo) risinājumu un eksperimentus, kas saistīti ar CFLA iepirkuma dokumentācijas pārbaudes sistēmas darbināšanu. Sistēma ir izstrādāta, izmantojot izguves papildinātas ģenerēšanas (RAG) algoritmu dokumentācijas pārbaudei ar lielo valodas modeli (LLM).
