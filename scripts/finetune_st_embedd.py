...
embedding_conf = {
    "embeddingmodel": "/tmp/Daiga/bge-m3",  # "sentence-transformers/paraphrase-multilingual-mpnet-base-v2",  # "BAAI/bge-m3",
    "fine_tuned": "bge_m3_lr5e-6_warmup28600",  # "paraphrase-multilingual-procurements",  # "bge-m3-procurements",
    "fine_tuned_path": "../bge_m3_lr5e-6_warmup28600",  # "../paraphrase-multilingual-procurements",
    "chunk_size": 1536,
    "chunk_overlap": 0,
}
